...
from operations import OPERATIONS_search_small, OPERATIONS_search_middle, OPERATIONS_search_small_Sep, WSReLUConvBN, FactorizedReduce, MaybeCalibrateSize, AuxHeadCIFAR, AuxHeadImageNet, apply_drop_path
