...
from operations import OPERATIONS_search_small, OPERATIONS_search_middle, OPERATIONS_search_small_WS_GN
...
parser.add_argument('--search_space', type=str, default='small', choices=['small', 'middle', 'small_with_WS_GN'])
...
def main():
    ...
    elif args.search_space == 'small_with_WS_GN':
