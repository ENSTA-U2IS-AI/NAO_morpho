...
from ops.operations import OPERATIONS_Deeplab
...
if __name__ =="__main__":
    model = NAODeepLab(output_stride=16, class_num=21, pretrained=False, freeze_bn=False)
    model.eval()
    # print(model)
