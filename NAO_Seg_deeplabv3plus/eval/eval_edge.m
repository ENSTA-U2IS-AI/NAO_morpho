...
%     orientation map
%     radius for nms supr
%     radius for supr boundaries
%     multiplier for conservative supr
%     number of threads for evaluation
    E=edgesNmsMex(E,O,1,5,1.01,4);%the param can be modify to adopt to ourself project
...
figure; edgesEvalPlot(resDir,'NAO UNET V1 HED&PASCAL');
