...
parser.add_argument('--val_per_iter', type=int, default=800)
...
def train(train_queue, model,criterion=None):
...
def build_BSD_500(model_state_dict, optimizer_state_dict, **kwargs):
    ...
    train_data =dataset.BSD_loader(root=root, split='train', random_crop=False, random_flip=False, normalisation=False)
